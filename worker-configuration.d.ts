/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 4b9b555872a252f621a775756bc52a27)
// Runtime types generated with workerd@1.20260625.1 2024-05-02 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DISCOUNT_QR_CODES: R2Bucket;
	RESEND_API_KEY: string;
	RESEND_TO_EMAIL: string;
	HASH_SALT: string;
	GOOGLE_PLACES_API_KEY: string;
	NEXT_PUBLIC_GOOGLE_PLACEID_ORLINSKIEGO: string;
	NEXT_PUBLIC_GOOGLE_PLACEID_PAWIA: string;
	NEXT_PUBLIC_GOOGLE_PLACEID_SLOWACKIEGO: string;
