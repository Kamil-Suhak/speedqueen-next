export const galleryEn = {
  ...
  images: [
    ...
    { src: "/images/gallery/b.jpg", alt: "Outside view - Orlińskiego St" },
    { src: "/images/gallery/c.jpg", alt: "Payment system - Orlińskiego St" },
    { src: "/images/gallery/d.jpg", alt: "Dryers - All laundromats" },
    { src: "/images/gallery/e.jpg", alt: "Waiting room - Orlińskiego St" },
    { src: "/images/gallery/f.jpg", alt: "Waiting room - Orlińskiego St" },
    ...
    { src: "/images/gallery/m2.jpg", alt: "Outside view - J. Słowackiego Alley" },
    ...
    { src: "/images/gallery/s.jpg", alt: "Ironing table - Szlak/Pawia St" },
    { src: "/images/gallery/t.jpg", alt: "Every waiting room has multiple electrical sockets" },
    { src: "/images/gallery/u.jpg", alt: "We accept touch-less transactions" },
