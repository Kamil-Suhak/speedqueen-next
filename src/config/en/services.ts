...
export const servicesEn = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "[[Professional grade detergents]] are automatically dispensed for cycles 1-5. !!Note: Cycles 6 and 7 allow you to use your own detergents.!!",
      icon: Zap,
    },
    {
      title: "Extras",
      description:
        "Wait for your laundry in our [[comfortable seating areas]]. Take advantage of our [[ozonating machine]] (at Al. Słowackiego) for sterilization and our [[ironing table]] (at ul. Pawia) for your convenience.",
      icon: Armchair,
    },
  ],
};
